...
namespace Delegates_HomeWork
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ShowEmployee(EmployeeInfo, list3);
        ...
        #region Task2
        public static bool Salaries(int salary)
        {
            return salary >= 1000;
        }

        public static void ShowInfo(Predicate<int> func, List<Person> list)
        {
        ...
        public static bool SelectBookAuthors(string book)
        {
            return book == "Nizami";
        }

        public static void ShowAuthors(Predicate<string> predicate, List<Book> list2)
        {
        ...
        public static bool EmployeeInfo(int age)
        {
            return age > 20 && age < 40;
        }

        public static void ShowEmployee(Predicate<int> predicate, List<Employee> list3)
        {
                int sum = 0;
                int count = 0;
